...
namespace Career_plan_system
{
    public partial class MainForm : Form
    {
        ...
        private void status2(object sender, EventArgs e)
        {
            this.label20.Text = this.listBox4.SelectedItem.ToString();
        }

        private void jobchange(object sender, EventArgs e)
        {
            if (this.listBox3.SelectedItem.ToString() == "计算机软、硬件/互联网/IT")
            {
                this.listBox4.Items.Clear();
                this.listBox4.Items.Add("软件工程师");
                this.listBox4.Items.Add("软件测试");
                this.listBox4.Items.Add("数据库开发工程师");
                this.listBox4.Items.Add("系统工程师");
                this.listBox4.Items.Add("网站运营管理");
                this.listBox4.Items.Add("网站编辑");
                this.listBox4.Items.Add("网页设计/制作");
                this.listBox4.Items.Add("网络与信息安全工程师");
                this.listBox4.Items.Add("游戏设计/开发");
            }
            if (this.listBox3.SelectedItem.ToString() == "金融/银行/证券/投资")
            {
                this.listBox4.Items.Clear();
                this.listBox4.Items.Add("银行会计/柜员");
                this.listBox4.Items.Add("信贷管理/资信评估");
                this.listBox4.Items.Add("项目经理/主管");
                this.listBox4.Items.Add("外汇交易/基金/国债经理人");
                this.listBox4.Items.Add("投资/理财服务");
                this.listBox4.Items.Add("融资经理/融资主管/专员");
                this.listBox4.Items.Add("客户经理/主管");
                this.listBox4.Items.Add("风险管理/控制/稽查");
            }

            if (this.listBox3.SelectedItem.ToString() == "通信技术")
            {
                this.listBox4.Items.Clear();
                this.listBox4.Items.Add("无线/射频通信工程师");
                this.listBox4.Items.Add("移动通信工程师");
                this.listBox4.Items.Add("项目经理/主管");
                this.listBox4.Items.Add("有线传输工程师");
                this.listBox4.Items.Add("通信技术工程师");
                this.listBox4.Items.Add("数据通信工程师");
            }

            if (this.listBox3.SelectedItem.ToString() == "教育/培训")
            {
                this.listBox4.Items.Clear();
                this.listBox4.Items.Add("教师/培训师");
                this.listBox4.Items.Add("教学/教务管理人员");
                this.listBox4.Items.Add("教授/讲师/助教");
                this.listBox4.Items.Add("教练");
                this.listBox4.Items.Add("家教");
                this.listBox4.Items.Add("幼教");
            }

            if (this.listBox3.SelectedItem.ToString() == "编辑/文案/传媒/影视/新闻")
            {
                this.listBox4.Items.Clear();
                this.listBox4.Items.Add("编辑/作家/撰稿人");
                this.listBox4.Items.Add("导演/编导/影视制作");
                this.listBox4.Items.Add("主持人/演员/模特/配音");
                this.listBox4.Items.Add("文案/策划");
                this.listBox4.Items.Add("出版/印刷/发行");
                this.listBox4.Items.Add("摄影师/记者");
                this.listBox4.Items.Add("化妆师/造型师/服装/道具");
                this.listBox4.Items.Add("后期制作/音效师");
            }

            if (this.listBox3.SelectedItem.ToString() == "美术/设计/创意")
            {
                this.listBox4.Items.Clear();
                this.listBox4.Items.Add("平面设计");
                this.listBox4.Items.Add("产品/包装设计");
                this.listBox4.Items.Add("创意指导/总监");
                this.listBox4.Items.Add("展示/装潢设计");
                this.listBox4.Items.Add("美术编辑/美术设计");
                this.listBox4.Items.Add("家具设计");
                this.listBox4.Items.Add("工艺品/珠宝设计");
                this.listBox4.Items.Add("多媒体/动画设计");
            }
            this.label19.Text = this.listBox3.SelectedItem.ToString();
            this.label20.Text = "";
        }
        ...
        {
            this.pictureBox3.Image = Career_plan_system.Properties.Resources.lx2;
        }

        private void pictureBox3_MouseLeave(object sender, EventArgs e)
        {
            this.pictureBox3.Image = Career_plan_system.Properties.Resources.lx;
        }

        private void pictureBox4_MouseLeave(object sender, EventArgs e)
        {
            this.pictureBox4.Image = Career_plan_system.Properties.Resources.lx;
        }

        private void pictureBox4_MouseMove(object sender, MouseEventArgs e)
        {
            this.pictureBox4.Image = Career_plan_system.Properties.Resources.lx2;
        }

        private void pictureBox5_MouseLeave(object sender, EventArgs e)
        {
            this.pictureBox5.Image = Career_plan_system.Properties.Resources.lx;
        }

        private void pictureBox5_MouseMove(object sender, MouseEventArgs e)
        {
            this.pictureBox5.Image = Career_plan_system.Properties.Resources.lx2;
        }

        private void pictureBox6_MouseLeave(object sender, EventArgs e)
        {
            this.pictureBox6.Image = Career_plan_system.Properties.Resources.lx;
        }

        private void pictureBox6_MouseMove(object sender, MouseEventArgs e)
        {
            this.pictureBox6.Image = Career_plan_system.Properties.Resources.lx2;
        }

        private void pictureBox7_MouseLeave(object sender, EventArgs e)
        {
            this.pictureBox7.Image = Career_plan_system.Properties.Resources.lx;
        }

        private void pictureBox7_MouseMove(object sender, MouseEventArgs e)
        {
            this.pictureBox7.Image = Career_plan_system.Properties.Resources.lx2;
        }

        private void pictureBox8_MouseLeave(object sender, EventArgs e)
        {
            this.pictureBox8.Image = Career_plan_system.Properties.Resources.lx;
        }

        private void pictureBox8_MouseMove(object sender, MouseEventArgs e)
        {
            this.pictureBox8.Image = Career_plan_system.Properties.Resources.lx2;
        }
        ...
        private void 职业测评ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.tabControl1.SelectedIndex = 1;
        }

        private void 路线更改ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.tabControl1.SelectedIndex = 2;
        }

        private void 自定义学习路线ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.tabControl1.SelectedIndex = 3;
        }
